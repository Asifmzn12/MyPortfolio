...
//         <div  ="fade-right" className="col-md-6 col-12">
//           <img src="./image/aboutme.svg" className="img-fluid vert-move"></img>

//         </div>
//         <div  ="fade-left" className="col-md-6 col-12 py-md-0 pt-lg-0 pt-3">
//           <div className="title d-flex flex-column  gap-0">
//             <h3>ABOUT ME</h3>
//             <p className="abouttxt">Passionate Frontend Developer with a solid foundation in HTML, CSS, JavaScript, Bootstrap, and Git. Eager to apply my skills and contribute to building innovative web applications.
//             </p>
